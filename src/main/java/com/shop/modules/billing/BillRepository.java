...
public interface BillRepository extends JpaRepository<Bill, UUID> {
    ...
    @Query("SELECT COALESCE(SUM(b.paidAmount), 0) FROM Bill b WHERE b.customer.id = :customerId AND b.status = com.shop.modules.billing.BillStatus.CONFIRMED")
    ...
    @Query("SELECT DISTINCT b.customer FROM Bill b WHERE " +
           "b.pendingAmount > 0 AND b.status = com.shop.modules.billing.BillStatus.CONFIRMED AND b.createdAt < :cutoff")
