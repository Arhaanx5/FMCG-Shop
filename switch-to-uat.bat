...
echo Switching profile to UAT...
"C:\Users\arhaa\AppData\Local\Microsoft\WinGet\Links\nssm.exe" set fmcg-backend AppParameters "-jar fmcg-shop-0.0.1-SNAPSHOT.jar --spring.profiles.active=uat"

echo Starting Backend Service...
powershell -Command "Start-Service fmcg-backend"

echo SUCCESS: Profile switched to UAT successfully!
pause
